...
/**
 * Uses `repak pack` to bundle the merged `AssetRegistry.bin` into a .pak file.
 ...
 */
async function runRepakForRegistry(stagingRoot, outputDir, ioBase, reporter = null) {
...
async function packageAllMods(modsFolder, enabledModIds = [], reporter = null, gameExePath = null) {
  ...
  await runRepakForRegistry(stagingRoot, outputDir, ioBase, reporter);
